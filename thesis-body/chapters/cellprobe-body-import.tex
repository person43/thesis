...
% \begin{theorem}
% \label{cellprobe:thm:explicit-vs-expnp} 
...
% \begin{theorem}
% \label{cellprobe:thm:explicit-vs-polystretch}
...
The only reason we needed to assume $t$ is odd is in our application of Theorem~\ref{cellprobe:thm:k-wise-csp}; if this theorem could be generalized to odd-arity XOR schemes (which seems attainable using methods for odd-arity CSPs, e.g. \cite{smoothed}), the results here would be valid for all $t > 2$.
